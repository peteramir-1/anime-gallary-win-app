...
const startFrontendServer = (callback = () => { }) => __awaiter(void 0, void 0, void 0, function* () {
    yield app.use(express.static(path.join(__dirname, '..', '..', 'views')));
...
if (((_a = process.env.mode) === null || _a === void 0 ? void 0 : _a.trim()) === 'development' && ((_b = process.env.NODE_APP) === null || _b === void 0 ? void 0 : _b.trim()) === 'frontend')
